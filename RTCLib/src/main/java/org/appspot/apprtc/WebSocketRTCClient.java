...
public class WebSocketRTCClient implements AppRTCClient, WebSocketChannelEvents {
  ...
  private static final String ROOM_JOIN = "api/joinroom";
  private static final String ROOM_MESSAGE = "api/message";
  private static final String ROOM_LEAVE = "api/leaveroom";
  ...
  public void onWebSocketMessage(final String msg) {
    ...
    try {
      ...
      reportError("WebSocket message JSON parsing error: " + msg);
    }
  }
